...
const AskUp = ({ text, thinkingBoxImage, mascotImage, mood }) => {
    ...
    height: isMobile ? '10rem' : '19rem', // Adjust height for mobile
}}>
    <img src={selectedMascotImage} alt="Selected Mascot" style={{maxWidth: '28vh', maxHeight: 'auto'}} />
</div>
